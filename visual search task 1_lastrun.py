...
expName = 'visual search task 1'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/saloni/Desktop/Lab in Psych/Psycopy/Visual Task/visual search task 1_lastrun.py',
